...
AVAILABLE_MODELS = {
    ...
    "gemini": [
        ("gemini-3.1-pro-preview", "Gemini 3.1 Pro (最新・推論・長文)"),
        ("gemini-3-flash-preview", "Gemini 3 Flash (最新・高速)"),
        ("gemini-3.1-flash-lite", "Gemini 3.1 Flash Lite (最新・低コスト)"),
        ("gemini-2.5-pro", "Gemini 2.5 Pro (前世代・推論・長文 2M context)"),
        ("gemini-2.5-flash", "Gemini 2.5 Flash (前世代・高速)"),
        ("gemini-2.5-flash-lite", "Gemini 2.5 Flash Lite (前世代・低コスト)"),
    ],
    "venice": [
